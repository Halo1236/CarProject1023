...
public class FragmentUtils {
    ...
    public static boolean isTopShowFragment(@NonNull FragmentManager fragmentManager, Fragment fragment) {
        return fragment == getTopShowFragmentIsInStack(fragmentManager, null, false);
    }
